...
def auto_deploy():
    ...
    subprocess.run(['git', 'commit', '-m', 'feat: Phase 3 complete - full Cloudflare KV CRUD, dynamic admin KPI autopilot, post-checkout hospitality actions, and iCal feed sync'], check=True)
